...
<body>
				...
				<ul class="rslides" id="slider3">
					<li>
						...
						<div class="slider_banner_info">
							<div class="w3ls-info">
								<h4>Yes we have <span>the best</span></h4>
								<p> Food for your Event. </p>
							</div>
						</div>
					</li>
					<li>
	...
	<!-- //Header -->
	<!-- Banner bottom -->
	<div class="bnr-btm-w3layouts">
		<div class="bnr-lft-agileits">
			<h2>Sign up with your name and email to receive news & latest offers.</h2>
		</div>
	...
	<div class="about-w3layouts" id="about">
		<div class="container">
			<div class="tittle-agileinfo">
				...
				<div class="about-top">
					<h3 class="subheading-agileits-w3layouts">Welcome to Mutai Food Services</h3>
					<p class="para-agileits-w3layouts">We are the leading catering service provider in town. we do weddings, board meetings, funerals and even birthdays. </p>
				</div>
			</div>
			...
			<div class="about-right">
				<h3 class="subheading-agileits-w3layouts sub-2">Expertise in industrial solution</h3>
	...
	<div class="features" id="features">
		<div class="col-md-6 banner-right-w3-agileits">
			<iframe src="https://player.vimeo.com/video/53208819?title=0&byline=0&portrait=0"></iframe>
		</div>
		<div class="col-md-6 agileits_updates_grid_right">
			<h5 class="title-w3">Why Choose Us?</h5>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title asd">
							...
							<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Meal to Go
						</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingTwo">
						<h4 class="panel-title asd">
							...
							<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Perfect Catering
						</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingThree">
						<h4 class="panel-title asd">
							...
							<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Private Dining
						</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<!-- <div class="panel-heading" role="tab" id="headingFour">
						<h4 class="panel-title asd">
							...
							<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Vehicle Parking
						</a>
						</h4>
					</div>
	...
	<div class="blog" id="blog">
		...
		<div class="blog-inner">
			<div class="wthree_events_grid">
				...
				<div class="event-grids">
					<div class="agileits_event_grid_date">
						<p>25.8.17</p><span>12:00</span>
					</div>
					<div class="agileinfo_events_grid1">
						<div class="events_info_w3ls">
							<a href="#" data-toggle="modal" data-target="#myModal">Nullam eu vehicula felis</a>
				...
				<div class="event-grids">
					<div class="agileits_event_grid_date">
						<p>9.8.17</p><span>12:00</span>
					</div>
					<div class="agileinfo_events_grid1 grid3 ">
						<div class="events_info_w3ls">
							<a href="#" data-toggle="modal" data-target="#myModal">Donec tempor justo nec orci</a>
							<p>Donec facilisis, orci a aliquet ultricies, lacus mauris vestibulum lorem, in malesuada augue sem sed dolor. Ut at
								metus vel enim elementum varius.Etiam ut cursus sem. Vestibulum dapibus a tellus eget viverra. Vestibulum non tellus
								in tortor scelerisque vulputate. Duis blandit erat non eros pellentesque pharetra.</p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
			<div class="events_-right_grid">
			</div>
			<div class="clearfix"> </div>
		</div>
	</div> -->
	...
	<div class="team agileits-w3layouts" id="team">
		<div class="container">
			<h5 class="title-w3">Our Kitchen Staff</h5>
			<div class="team-w3ls">
		...
		<div id="small-dialog" class="mfp-hide book-form">
			<div class="pop-up-content-agileits-w3layouts">
				...
				<div class="col-md-6 w3ls-right">
					<h4>Lorem ipsum</h4>
					<p>Lorem ipsum dolor sit amet, consectetur <span>adipiscing elit</span>. Praesent dictum magna sit amet purus fermentum
						consectetur. </p>
					<p>Lorem ipsum dolor sit amet, consectetur. Praesent dictum magna sit amet <span>adipiscing elit</span>.purus fermentum
						consectetur. </p>
	...
	<div class="testimonials" id="testimonials">
		<div class="container">
			<h5 class="title-w3">Our Happy Customers</h5>
			<div class="col-md-12 col-xs-12" data-wow-delay="0.2s">
				<div class="carousel slide" data-ride="carousel" id="quote-carousel">
					<!-- Bottom Carousel Indicators -->
					<ol class="carousel-indicators">
						<li data-target="#quote-carousel" data-slide-to="0" class="active"><img class="img-responsive " src="images/test1.jpg" alt="">
						</li>
						<li data-target="#quote-carousel" data-slide-to="1"><img class="img-responsive" src="images/test2.jpg" alt="">
						</li>
						<li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="images/test3.jpg" alt="">
						</li>
					</ol>
					...
					<div class="carousel-inner text-center">
						...
						<div class="item active">
							<blockquote>
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2 client-agileits-w3layouts">
	...
	<!-- Map -->
	<div class="map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1274.966616428014!2d35.28480277644752!3d-0.3718723353473297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182a5778a70a0e19%3A0x9e111200e6923897!2sKericho!5e0!3m2!1sen!2ske!4v1527325436324" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
	</div>
	<!-- //Map -->
	<!-- footer -->
	<div class="footer">
		<div class="container">
			<div class="col-md-4 footerleft">
				...
				<ul class= 'list-group'>
                <li class= 'list-group-item'><a href="index.html" class="active scroll">Home</a></li>
									<li class= 'list-group-item'><a href="#about" class="scroll">About</a></li>
									<!-- <li class= 'list-group-item'><a href="#blog" class="scroll">Blog</a></li> -->
									<li class= 'list-group-item'><a href="#gallery" class="scroll">Gallery</a></li>
                                    <li class= 'list-group-item'><a href="#contact" class="scroll">Contact</a></li>
                                    <li class= 'list-group-item'><a href="/hire" >Hire Us</a></li>
                </ul>
			</div>
			<div class="col-md-4 footermiddle">
				<h3>Get in touch</h3>
				<p>63 Kenyatta Road, Kericho</p>
				<p>p O Box 12345, Kericho</p>
				<p class="phone">phone: +243(771) 427 283</p>
				<!-- <p class="phone">Fax: +0(21) 334 5678</p> -->
				<p class="phone">Mail: <a href="mailto:info@example.com">info@mutai.co.ke</a></p>
			</div>
	...
	<div class="wthree_copy_right">
		<div class="container">
			<p>© 2018 Mutai Food Services. All rights reserved | Design by <a href="itsdavis.me">Davis Too</a></p>
