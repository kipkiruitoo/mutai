...
@section('content')
    ...
    @can('crm_note_create')
    <p>
        <a href="{{ route('admin.crm_notes.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
                        ...
                        @foreach ($crm_notes as $crm_note)
                            <tr data-entry-id="{{ $crm_note->id }}">
                                ...
                                <td field-key='note'>{!! $crm_note->note !!}</td>
                                                                <td>
                                    @can('crm_note_view')
                                    <a href="{{ route('admin.crm_notes.show',[$crm_note->id]) }}" class="btn btn-xs btn-primary">@lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('crm_note_edit')
                                    <a href="{{ route('admin.crm_notes.edit',[$crm_note->id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('crm_note_delete')
{!! Form::open(array(
